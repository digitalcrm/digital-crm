...
class ConsumerController extends Controller
{
    ...
    public function getProducts($skipRec, $min_price, $max_price, $procatId, $prosubcatId, $keyword, $sortby)
    {
        ...
        if (($procatId == 0) && ($keyword != '')) {
            ...
            $procatId = (($catVal != '') && ($catVal > 0)) ? $catVal->procat_id : 0;
        ...
        if (($prosubcatId == 0) && ($keyword != '')) {
            ...
            $prosubcatId = (($subcatVal != '') && ($subcatVal > 0)) ? $subcatVal->prosubcat_id : 0;
        ...
        // if ($keyword != '') {
        //     // Brand
        //     $vendors = DB::table('tbl_products')->where('tbl_products.procat_id', '>', 0)->where('tbl_products.prosubcat_id', '>', 0)->where('vendor', 'like', '%' . $keyword . '%')->where('active', 1)->where('store', 1);
        ...
        $query = DB::table('tbl_products')->where('tbl_products.procat_id', '>', 0)->where('tbl_products.prosubcat_id', '>', 0)->where('tbl_products.company', '>', 0);
    ...
    public function searchProductByVendor($skipRec, $min_price, $max_price, $procatId, $prosubcatId, $keyword, $sortby)
    {
        ...
        $vendors = DB::table('tbl_products')->where('tbl_products.procat_id', '>', 0)->where('tbl_products.prosubcat_id', '>', 0)->where('tbl_products.company', '>', 0)
    ...
    public function getProductBrandslist()
    {
        $brands = DB::table('tbl_products')->where('vendor', '!=', null)->distinct('vendor')->select(
            'tbl_products.vendor'
        )->get();
        return $brands;
    }
