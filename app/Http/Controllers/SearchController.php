...
class SearchController extends Controller {
    ...
    public function getSearchResults(Request $request) {
        ...
        //Orders
        $orders = Tbl_orders::
                    // with(['tbl_deals' => function($query) use ($search){
                    //     $query->where('tbl_deals.name', 'like', '%' . $search . '%');
                    // }])
        ...
        // if($selectedField == 'All') {
            ...
            //  Assign request input term to search variable

            //  Get results - accounts table
            ...
            if (count($accounts) > 0) {
                foreach ($accounts as $account) {
                    ...
                    $table .= '<td>Account</td>';
                //  $table .= '<td><a href="#" class="btn btn-default">View</a></td>';
                    $table .= '</tr>';
                }
            }
    ...
    // return view('auth.search')->with("data", $data);
    return view('auth.search', compact('data','selectedField'));
