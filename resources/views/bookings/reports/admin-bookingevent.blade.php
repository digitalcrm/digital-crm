...
<script>
    ...
    var dayurl = "{{url('admin/reports/getDayAppointment/{time}/{form_id}/{user_id}')}}";
    var weekurl = "{{url('admin/reports/getWeekAppointment/{time}/{form_id}/{user_id}')}}";
    var monthurl = "{{url('admin/reports/getMonthAppointment/{time}/{form_id}/{user_id}')}}";
    ...
    $(function() {
        ...
        getDayappointments(default_form, firstUser);

        $("#forms").change(function() {
            var user = $("#selectUser").val();
            var id = $(this).val();
            if (chart == 'day') {
                getDayappointments(id, user);
            }
            if (chart == 'week') {
                getWeekappointments(id, user);
            }
            if (chart == 'month') {
                getMonthappointments(id, user);
            }
        });
    ...
    function getMonthappointments(id, user) {
    ...
    function getWeekappointments(id, user) {
