    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-5 text-right pull-right">
                <a class="btn btn-primary px-3" href="{{ route('activity_type.create') }}"><i class="far fa-plus-square mr-1"></i> Create</a>
            </div>
        </div>
    </section>
	...
	<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <form action="{{ route('activity_type.update', $activity_type->id) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="card-body">
