...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h1>Import Product Sub Category</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <!-- <form role="form" > -->
                        {{Form::open(['action'=>'Admin\ProductSubCategoryController@importData','method'=>'Post','enctype'=>'multipart/form-data'])}}
                        @csrf
                        <div class="card-body p-0">
                            ...
                            <section class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="procat_id" name="procat_id" required>
                                        {!!$data['useroptions']!!}
                                    </select>
                                ...
                                <div class="form-group">
                                    <p><a href="<?php echo url('uploads/samples/tbl_product_subcategory_upload.csv'); ?>">click here to download sample csv file</a></p>
                                </div>
                            </section>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer bg-white border-top text-right pull-right">
                            <a href="{{url('admin/productsubcategorys')}}" class="btn btn-default">Back</a>
