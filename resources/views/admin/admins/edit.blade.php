                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="arole" class="col-sm-2 control-label">User Role</label>
                                <div class="col-sm-10">
                                    <select class="form-control" name="arole" id="arole" required>
                                        {!!$data['roleSelect']!!}
                                    </select>
                                    <span class="text-danger">{{ $errors->first('arole') }}</span>
                                </div>
                            </div>
