...
<script>
    ...
    var dayurl = "{{url('admin/reports/getDaytickets/{time}/{form_id}/{user_id}')}}";
    var weekurl = "{{url('admin/reports/getWeektickets/{time}/{form_id}/{user_id}')}}";
    var monthurl = "{{url('admin/reports/getMonthtickets/{time}/{form_id}/{user_id}')}}";
    ...
    $(function() {
        ...
        getDaytickets(default_form, firstUser);

        $("#forms").change(function() {
            var user = $("#selectUser").val();
            var id = $(this).val();
            if (chart == 'day') {
                getDaytickets(id, user);
            }
            if (chart == 'week') {
                getWeektickets(id, user);
            }
            if (chart == 'month') {
                getMonthtickets(id, user);
            }
        });
    ...
    function getDaytickets(id, user) {
    ...
    function getMonthtickets(id, user) {
    ...
    function getWeektickets(id, user) {
