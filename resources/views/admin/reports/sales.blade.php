	...
	<div class="container-fluid">
        ...
        <div class="row">
                ...
                @include('includes.adminlte-boot-4.admin.report_sidebar')
                        ...
                        <a href="{{url('admin/sales')}}" class="btn btn-outline-secondary"><i class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                    </div>
                            </div>
                        </div>
                    <!-- /.card -->
...
<script>
                                                var dayurl = "{{url('admin/reports/getDaySales')}}";
                                                var weekurl = "{{url('admin/reports/getWeekSales')}}";
                                                var monthurl = "{{url('admin/reports/getMonthSales')}}";
