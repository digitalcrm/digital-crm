	...
	<div class="container-fluid">
        ...
        <div class="row">
                ...
                @include('includes.adminlte-boot-4.admin.report_sidebar')
                        ...
                        <a href="{{url('admin/customers')}}" class="btn btn-outline-secondary"><i class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                    </div>
                            </div>
                        </div>
                    <!-- /.card -->
...
<script>
                                                var dayurl = "{{url('admin/reports/getDayCustomers')}}";
                                                var weekurl = "{{url('admin/reports/getWeekCustomers')}}";
                                                var monthurl = "{{url('admin/reports/getMonthCustomers')}}";
                                                ...
                                                $(function() {
                                                    ...
                                                    getDayCustomers(firstUser);

                                                    $("#selectUser").change(function() {
                                                        var user = $(this).val();
                                                        if (chart == 'day') {
                                                            getDayCustomers(user);
                                                        }
                                                        if (chart == 'week') {
                                                            getWeekCustomers(user);
                                                        }
                                                        if (chart == 'month') {
                                                            getMonthCustomers(user);
                                                        }
                                                    });
                                                });
                                                ...
                                                function getMonthCustomers(user) {
                                                ...
                                                function getWeekCustomers(user) {
