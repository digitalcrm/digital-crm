                    ...
                    <div class="card shadow card-primary card-outline card-primary card-outline card-primary card-outline">
                        <div class="card-header with-border">
                            <div class="col-lg-10 float-left">
                                <h3 class="card-title">Product Leads</h3>
                            </div>
...
<script>
    /**/
    var dayurl = "{{url('admin/reports/getdayproductleads')}}";
    var weekurl = "{{url('admin/reports/getweekproductleads')}}";
    var monthurl = "{{url('admin/reports/getmonthproductleads')}}";
