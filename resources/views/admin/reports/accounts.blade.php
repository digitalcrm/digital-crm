	...
	<div class="container-fluid">
        ...
        <div class="row">
                ...
                @include('includes.adminlte-boot-4.admin.report_sidebar')
                        ...
                        <a href="{{url('admin/accounts')}}" class="btn btn-outline-secondary"><i class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                    </div>
                            </div>
...
<script>
                                                var dayurl = "{{url('admin/reports/getDayAccounts')}}";
                                                var weekurl = "{{url('admin/reports/getWeekAccounts')}}";
                                                var monthurl = "{{url('admin/reports/getMonthAccounts')}}";
                                                ...
                                                $(function() {
                                                    ...
                                                    $("#selectUser").change(function() {
                                                        ...
                                                        if (chart == 'week') {
                                                            getWeekAccounts(user);
                                                        }
                                                        if (chart == 'month') {
                                                            getMonthAccounts(user);
                                                        }
                                                    });
                                                });
...
//                                                alert('Days ' + result);
                                                ...
                                                function getMonthAccounts(user) {
