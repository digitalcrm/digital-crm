	...
	<div class="container-fluid">
        ...
        <div class="row">
                ...
                @include('includes.adminlte-boot-4.admin.report_sidebar')
                        ...
                        <a href="{{url('admin/contacts')}}" class="btn btn-outline-secondary"><i class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                    </div>
							</div>
                        </div>
                    <!-- /.card -->
...
<script>
                                                var dayurl = "{{url('admin/reports/getDayContacts')}}";
                                                var weekurl = "{{url('admin/reports/getWeekContacts')}}";
                                                var monthurl = "{{url('admin/reports/getMonthContacts')}}";
                                                ...
                                                $(function() {
                                                    ...
                                                    $("#selectUser").change(function() {
                                                        ...
                                                        if (chart == 'week') {
                                                            getWeekContacts(user);
                                                        }
                                                        if (chart == 'month') {
                                                            getMonthContacts(user);
                                                        }
                                                    });
                                                });
...
//                                        alert('Days ' + result);
                                                ...
                                                function getMonthContacts(user) {
