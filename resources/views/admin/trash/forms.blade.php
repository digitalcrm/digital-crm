        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-10 mt-1">
                    <h1 class="m-0 text-dark">Forms <small class="badge badge-secondary" id="total">{{$data['total']}}</small></h1>
                </div>
				<div class="col-sm-2">
					<select class="form-control form-control-sm" id="selectUser" name="selectUser">
                                {!!$data['useroptions']!!}
                            </select>
				</div>
            </div>
...
<script>
    var dayurl = "{{url('admin/trash/getuserforms')}}";
    $(function() {
