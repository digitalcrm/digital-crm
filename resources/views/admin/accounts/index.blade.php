        ...
        <div class="container-fluid">
            <div class="row mb-0">
                <div class="col-sm-4 mt-0">
                    <h1 class="m-0 text-dark">Accounts <small id="total" class="badge badge-secondary">{{$data['total']}}</small></h1>
                </div>
                <div class="col-sm-8">
...
<script>
    var accountsurl = "{{url('admin/ajax/getUserAccounts')}}";
    var deleteAllUrl = "{{url('admin/accounts/deleteAll/{id}')}}";
    $(function() {
...
//            alert(uid);
    ...
    function getAccounts(uid){
            ...
            $.get(accountsurl, {'uid': uid}, function(result) {
//                alert(result);
                var res = eval("(" + result + ")");
