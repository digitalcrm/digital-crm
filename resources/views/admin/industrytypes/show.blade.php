      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Show Industry Type</li>
          </ol>
        </div>
      </div>
    </section>       
          ...
          <!-- general form elements -->
            ...
            <div class="box box-primary">
              ...
              <div class="box-footer">
                <a href="{!!$data['deleteLink']!!}" class="btn btn-danger pull-left">Delete</a>
                <a href="{{url('admin/leads')}}" class="btn btn-primary pull-right">Back</a>
              </div>
          </div>
