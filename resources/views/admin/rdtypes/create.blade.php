            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{Form::open(['action'=>'Admin\RdtypeController@store','method'=>'Post','class' => 'form-horizontal'])}}
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="account_type" class="control-label">Rd Type</label>
                                    </div>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="type" id="type" placeholder="RD Type" value="{{old('type')}}" required>
