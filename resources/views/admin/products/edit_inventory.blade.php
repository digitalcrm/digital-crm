            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        {{Form::open(['action'=>['Admin\ProductController@updateInventory',$data['product']->pro_id],'method'=>'Post','enctype'=>'multipart/form-data'])}}
                        @csrf
                        <div class="card-body">
                            <!-- Left col -->
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <span class="invalid-feedback" role="alert"><strong>{{ $errors->first('productid') }}</strong></span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="invalid-feedback" role="alert"><strong>{{ $errors->first('qrcode') }}</strong></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <span class="invalid-feedback" role="alert"><strong>{{ $errors->first('productsku') }}</strong></span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span class="invalid-feedback" role="alert"><strong>{{ $errors->first('supply_price') }}</strong></span>
                                    </div>
                        ...
                        <div class="card-footer bg-white border-top text-right pull-right">
                            <a href="{{url('admin/products/inventory/list')}}" class="btn btn-outline-secondary">Cancel</a>
