...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-0">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{!!$data['forms']->title!!} - Form Leads <small
                            class="badge badge-secondary">{{ $data['total'] }}</small></h1>
                </div>
            </div>
            <!-- /.row -->
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-footer bg-white border-top text-right pull-right">
                            <button type="button" value="Delete" class="btn text-danger btn-outline-secondary"
                                onclick="return deleteAll();"><i class="far fa-trash-alt"></i></button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" data-clipboard-target="#tab_2" id="copy-btn"
                    class="btn btn-primary copy-text">Copy</button>
            </div>
        </div><!-- modal-content -->
    </div><!-- modal-dialog -->
</div>
