                ...
                <div class="col-md-3">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-body card-profile p-0">
                            <ul class="list-group list-group-unbordered">
                                ...
                                <!-- <li class="list-group-item">
                                    <b>Category</b> <a class="pull-right"><?php echo ($data['tbl_industrytypes'] != null) ? $data['tbl_industrytypes']['type'] : ''; ?></a>
                                </li> -->
                                <li class="list-group-item">
                        ...
                        <div class="card-footer">
                            <div class="btn-group pull-left">
                                ...
                                <a href="<?php echo url('admin/rds/' . $data['rd_id'] . '/edit'); ?>" class="btn btn-sm btn-primary btn-block"><b>Edit</b></a>
                            </div>
                        </div>
                    </div>
                    <!-- /.card -->
                    ...
                    <!-- <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted"><?php echo ($data['accounts'] != null) ? $data['accounts']['street'] : ''; ?>
                                <?php echo ($data['accounts'] != null) ? ', ' . $data['accounts']['city'] : ''; ?>
                                <?php echo ($data['accounts'] != null) ? ', ' . $data['accounts']['tbl_states']['name'] : ''; ?>
                                <?php echo ($data['accounts'] != null) ? ', ' . $data['accounts']['tbl_countries']['name'] : ''; ?>
                                <?php echo ($data['accounts'] != null) ? ', ' . $data['accounts']['zip'] : ''; ?></p>
