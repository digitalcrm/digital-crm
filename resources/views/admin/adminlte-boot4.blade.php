        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="box box-info">
                    ...
                    <div class="box-body" id='yearData'>
                        {!!$data['yearData']!!}
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="box box-info">
                    ...
                    <div class="box-body" id='funnelDiv'>
                        <div class="text-bold">
                            <h4 id="wonAmount"></h4>
                        </div>
                        <div id="funnelPanel">
            ...
            <div class="col-lg-6">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <div class="col-lg-8 pull-left">
                            <h3 class="box-title">Deal Stage</h3>
                        </div>
                        <div class="col-lg-4">
...
<!--
       <div class="row">
           <div class="col-lg-3 col-xs-6">
               <div class="small-box bg-aqua bg-dashboard">
                   <div class="inner">
                       <h3>{!!$data['users']!!}</h3>
                       <p>Users</p>
                   </div>
           ...
           <div class="col-lg-3 col-xs-6">
               <div class="small-box bg-green bg-dashboard">
                   <div class="inner">
           ...
           <div class="col-lg-3 col-xs-6">
               <div class="small-box bg-yellow bg-dashboard">
                   <div class="inner">
                       <h3>{!!$data['deals']!!}</h3>
                       <p>Deals</p>
                   </div>
           ...
           <div class="col-lg-3 col-xs-6">
               <div class="small-box bg-red bg-dashboard">
                   <div class="inner">
                       <h3>{!!$data['leads']!!}</h3>
                       <p>Leads</p>
                   </div>
           ...
           <div class="col-lg-3 col-xs-6">
               <div class="small-box bg-orange bg-dashboard">
                   <div class="inner">
                       <h3>{!!$data['forms']!!}</h3>
                       <p>Forms</p>
                   </div>
           ...
           <div class="col-lg-3 col-xs-6">
               <div class="small-box bg-blue bg-dashboard">
                   <div class="inner">
                       <h3>{!!$data['accounts']!!}</h3>
