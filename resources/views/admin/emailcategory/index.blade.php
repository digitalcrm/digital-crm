...
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
        ...
        <div class="row">
            <div class="col-md-7">                
                <h1>
                    Email Category <small id="total" class="badge">{{$data['total']}}</small>
                </h1>
            </div>
            <div class="col-md-5 text-right pull-right">
                <a class="btn btn-primary px-3" href="{{url('admin/department/create')}}"><i class="far fa-plus-square mr-1"></i> New Email Category</a>
            </div>
        </div>
    </section> 
    <!-- Main content -->
