            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <!-- form start -->
                        <!-- <form role="form" > -->
                        {{Form::open(['action'=>['Admin\ProjectController@update',$data->project_id],'method'=>'Post'])}}
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="" value="{{$data->name}}" required tabindex="1">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="code" id="code" placeholder="" value="{{$data->code}}" required tabindex="2">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="forecast" id="forecast" placeholder="" value="{{$data->forecast}}" required tabindex="6" onkeyup="return calculateForecast();">
                                        <span class="text-danger">{{ $errors->first('forecast') }}</span>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="actual_days">Actual Man Days</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
                                        <input type="text" class="form-control" name="actual_days" id="actual_days" placeholder="" value="{{$data->actual_days}}" required tabindex="">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="total_forecast" id="total_forecast" placeholder="" value="{{$data->total_forecast}}" required tabindex="">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="pro_code">Leaves</label>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="pro_manager">Working on different project</label>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="pro_code">Company Activity</label>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="pro_manager">Working</label>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="pro_manager">Others</label>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="pro_code">Marketing Collaterals</label>
                                        ...
                                        <span class="text-danger">{{ $errors->first('marketing_collateral') }}</span> </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="pro_code">Sample Pages</label>
                                        ...
                                        <span class="text-danger">{{ $errors->first('sample_pages') }}</span> </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="pro_code">Client Date</label>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="pro_code">Feedback</label>
                        ...
                        <div class="card-footer bg-white border-top pull-right text-right">
                            <a href="{{url('admin/projects')}}" class="btn btn-outline-secondary mr-1">Cancel</a>
...
<script>
    ...
    var submissiondateurl = "{{url('admin/projects/getSubmissionDate/{startDate}/{days}')}}";
    $(function() {
