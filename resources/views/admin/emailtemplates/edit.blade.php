        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    {{Form::open(['action'=>['Admin\EmailTemplateController@update',$data['emailtemplate']->temp_id],'method'=>'Post','class' => 'form-horizontal'])}} 
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" value="<?php echo $data['emailtemplate']->subject; ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <textarea id="message" name="message" rows="10" cols="80" required><?php echo $data['emailtemplate']->message; ?></textarea>
