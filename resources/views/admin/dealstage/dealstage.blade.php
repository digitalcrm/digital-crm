    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-md-2 text-right pull-right">
                <a class="btn btn-primary px-3" href="{{url('admin/dealstage/create')}}"><i class="far fa-plus-square mr-1"></i> New Deal Stage</a>
            </div>
        </div>
    </section> 
    <!-- Main content -->
...
<script>
    ...
    $(function() {
        ...
        $("#lidealstage").addClass("active");
        $("#lidealstage").parent('#uldealstage ul').css('display', 'block').addClass("menu-open");
        $("#uldealstage").parent('#ulsettings ul').css('display', 'block').addClass("menu-open");
