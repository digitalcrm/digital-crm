                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            $companies = (($data != '') && ($data->companies == 1)) ? 'checked' : '';
                            $appointments = (($data != '') && ($data->appointments == 1)) ? 'checked' : '';
                            $productleads = (($data != '') && ($data->productleads == 1)) ? 'checked' : '';
                            $campaigns = (($data != '') && ($data->campaigns == 1)) ? 'checked' : '';
                            $ticketing = (($data != '') && ($data->ticketing == 1)) ? 'checked' : '';
                            ...
                            <table class='table table-striped table-bordered'>
                                ...
                                <tr>
                                    <td><label><input type='checkbox' name='companies' id='companies' <?php echo $companies; ?>>&nbsp;Companies</label></td>
                                    <td><label><input type='checkbox' name='appointments' id='appointments' <?php echo $appointments; ?>>&nbsp;Appointments</label></td>
                                    <td><label><input type='checkbox' name='productleads' id='productleads' <?php echo $productleads; ?>>&nbsp;Product Leads</label></td>
                                    <td><label><input type='checkbox' name='campaigns' id='campaigns' <?php echo $campaigns; ?>>&nbsp;Campaign</label></td>
                                </tr>
                                <tr>
                                    <td><label><input type='checkbox' name='ticketing' id='ticketing' <?php echo $ticketing; ?>>&nbsp;Ticketing</label></td>
                                </tr>
