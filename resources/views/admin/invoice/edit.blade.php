            ...
            <div class="col-lg-12">
                ...
                <div class="card card-primary">
                    <div class="card-header with-border">
                        <h3 class="card-title">
                            <?php echo $data['invoice']->name; ?>
                        </h3>
                    </div>
                    {{Form::open(['action'=>['Admin\InvoiceController@update',$data['invoice']->inv_id],'method'=>'Post','enctype'=>'multipart/form-data'])}}
                    @csrf
                    <div class="card-body">
                        <section class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control float-right" id="datepicker" name="date" value="<?php echo date('d-m-Y', strtotime($data['invoice']->inv_date)); ?>">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="cmp_logo">Company Logo</label><br>
                            ...
                            <div class="col-lg-5 float-right">
                                <table class="table table-striped table-bordered" id="">
                                    <tbody>
                                        <tr>
                                            <td>Sub Total</td>
                                            <td><input type="text" name="subTotal" id="subTotal" class="form-control" value="<?php echo $data['invoice']->subtotal; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Discount (%)</td>
                                            <td><input type="text" name="discount" id="discount" class="form-control" onkeyup="return discountTotal();" value="<?php echo $data['invoice']->discount; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Shipping</td>
                                            <td><input type="text" name="shipping" id="shipping" class="form-control" onkeyup="return calculateTotal();" value="<?php echo $data['invoice']->shipping; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Total</td>
                                            <td><input type="text" name="totalAmount" id="totalAmount" class="form-control" value="<?php echo $data['invoice']->total_amount; ?>"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="card-footer bg-white border-top">
                        <div class="btn-group btn-flat float-right">
                            <a href="{{url('admin/invoices')}}" class="btn btn-default">Back</a>
...
//            $("#" + id).parent('td').siblings('td').find(':input.quantity').val(1);
            ...
            $("#price" + id).val(Number(proData[proDatalength - 1])).attr('readonly', true);
            $("#quantity" + id).val(1);
            calculateTotal();
        }
