    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="row">
            <div class="col-md-7 mb-1">                
                <h1>
                    Round Robin Allocation <span class="badge badge-secondary" id="total"></span>
                </h1>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card shadow card-primary card-outline">
                    {{Form::open(['action'=>['Admin\LeadController@allocateLeadsQuotatoUser',Auth::user()->id],'method'=>'Post','enctype'=>'multipart/form-data','class'=>'form-horizontal'])}}
                    @csrf
                    <!-- /.card-header -->
