            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        {{Form::open(['action'=>'Admin\RoleController@store','method'=>'Post','class' => 'form-horizontal'])}}
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Role" value="{{old('name')}}" required>
