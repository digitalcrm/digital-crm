                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-footer bg-white border-top text-right pull-right">
                            <a href="{{url('admin/clients')}}" class="btn btn btn-outline-secondary">Back</a>
                            <a href="<?php echo url('admin/clients/' . $data['userdata']['id'] . '/edit') ?>" class="btn btn-primary">Edit</a>
                        </div>
                        <!-- /.card-footer -->
                        </form>
                    </div>
