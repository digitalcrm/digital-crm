        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    {{Form::open(['action'=>'Admin\AccountTypeController@store','method'=>'Post','class' => 'form-horizontal'])}} 
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="account_type" id="account_type" placeholder="Account Type" value="{{old('account_type')}}" required>
