            ...
            <div class="col-lg-6">
                ...
                <div class="card card-info">
                    <div class="card-header with-border">
                        <h3 class="card-title">Create Post Order Stage</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    {{Form::open(['action'=>'Admin\PostOrderStageController@store','method'=>'Post','class' => 'form-horizontal'])}} 
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="stage" class="col-sm-3 control-label">Post Order Stage</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="stage" id="salesfunnel" placeholder="Post Order Stage" value="{{old('stage')}}" required>
