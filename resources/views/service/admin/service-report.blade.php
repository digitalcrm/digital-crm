...
<script>
    ...
    var dayurl =
        "{{ url('admin/reports/getDayServices/{time}/{form_id}/{user_id}') }}";
    var weekurl =
        "{{ url('admin/reports/getWeekServices/{time}/{form_id}/{user_id}') }}";
    var monthurl =
        "{{ url('admin/reports/getMonthServices/{time}/{form_id}/{user_id}') }}";
    ...
    $(function () {
        ...
        getDayServices(default_form, firstUser);

        $("#forms").change(function () {
            var user = $("#selectUser").val();
            var id = $(this).val();
            if (chart == 'day') {
                getDayServices(id, user);
            }
            if (chart == 'week') {
                getWeekServices(id, user);
            }
            if (chart == 'month') {
                getMonthServices(id, user);
            }
        });
    ...
    function getDayServices(id, user) {
        $.get(dayurl, {
            'time': 'day',
            'form_id': id,
            'user_id': user
    ...
    function getMonthServices(id, user) {
        $.get(monthurl, {
            'time': 'month',
            'form_id': id,
            'user_id': user
    ...
    function getWeekServices(id, user) {
        $.get(weekurl, {
            'time': 'week',
            'form_id': id,
            'user_id': user
