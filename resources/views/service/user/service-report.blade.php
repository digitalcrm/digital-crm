                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active"
                                    ...
                                    aria-controls="home"
                                    aria-selected="true"
                                    onclick="return getFormServices('days');">Day</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"
                                    id="profile-tab"
                                    ...
                                    onclick="return getFormServices('weeks');">Week</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"
                                    id="contact-tab"
                                    ...
                                    onclick="return getFormServices('months');">Month</a>
                            </li>
                        </ul>
...
<script>
    ...
    var dayurl = "{{url('reports/getDayServices/{time}/{form_id}')}}";
    var weekurl = "{{url('reports/getMonthServices/{time}/{form_id}')}}";
    var monthurl = "{{url('reports/getWeekServices/{time}/{form_id}')}}";
    $(function() {

        getDayServices(default_form);
        $("#timer").val('days');
