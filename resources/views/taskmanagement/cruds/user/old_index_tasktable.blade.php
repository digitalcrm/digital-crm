                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6">
                            <h5><i class="fas fa-tasks"></i> Add Task</h5>
                            </div>
                            {{-- <div class="col-6">
                        ...
                        <table id="exampletable" class="table table-bordered table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- @if(!empty($task->outcome_id))
                                        <a class="badge badge-pill badge-success">{{ $task->outcome->name ?? ''}}</a>
                                        @else
                                        <a class="badge badge-pill badge-secondary">Processing</a>
                                        @endif --}}
    ...
    <div class="modal-dialog modal-dialog-slideout" role="document">
        <div class="modal-content">
            ...
            {{-- <div class="modal-footer">
                <button type="" class="btn btn-primary">Reset All</button>
            </div> --}}
        </div>
    </div>
</div>
