        ...
        <div class="container-fluid">
            <div class="row mb-0">
                <div class="col-sm-4 mt-0">
                    <h1 class="m-0 text-dark">UserTasks <small class="badge badge-secondary">{{ count($tasks) }}</small>
                    </h1>
                    ...
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a class="btn btn-sm  btn-primary mr-1 px-3"
                                href="{{ route('taskmanagement.create') }}"><i
                                    class="far fa-plus-square mr-1"></i>New Task
                            </a>
            ...
            <div class="col-12">
                ...
                <div class="card">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input id="{{ $task->id }}" data-id="{{ $task->id }}"
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-1">
                                                    <form style="display:none" id="form-checked-{{ $task->id }}"
                                                    ...
                                                    <a href=""
                                                        ...
                                                        id="linethrough" onclick="event.preventDefault();
                                                        if(confirm('Want\'s to complete the Task!')){
                                                            $('#form-checked-{{ $task->id }}').submit();
                                                ...
                                                <div class="col mx-2">
                                                    {{-- below title part --}}
                                                    <a class="mx-1"
                                                        href="{{ route('taskmanagement.show',$task->id) }}">
                                        ...
                                        <td>
                                            ...
                                            Carbon\Carbon::parse($task->completed_at)->format('d-m-Y') : '<span
                                                class="badge badge-warning">Not Completed Yet</span>' !!}
                                        </td>

                                        <td>
                                            @if($task->outcome_id == 9)
                                                <a
                                                    class="badge badge-pill badge-success">{{ $task->outcome->name ?? '' }}</a>
                                            @else
                                                <a
                                                    class="badge badge-pill badge-secondary">{{ $task->outcome->name ?? '' }}</a>
                                            @endif
                                                ...
                                                <div class="dropdown-menu">
                                                    <small>
                                                        <a class="dropdown-item"
                                                            href="{{ route('taskmanagement.edit',$task->id) }}">
                                                            Edit
                                                        </a>
                                                    </small>
                                                    <small>
                    ...
                    <div class="border-top bg-white card-footer text-muted">
                        <button class="btn btn-sm btn-outline-secondary delete-all" data-url=""><i
    ...
    $(document).ready(function () {
        $('#exampletable').DataTable({
            ...
            initComplete: function () {
                this.api().columns([3, 4, 5, 9]).every(function (
                d) { //THis is used for specific column
                    ...
                    var select = $('<label class="badge badge-secondary m-1">' + theadname +
                            ': All</label>')
