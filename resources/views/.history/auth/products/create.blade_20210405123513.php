                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="description" class="col-md-3 col-form-label text-right">Description</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="store" class="col-md-3 col-form-label text-right">Store</label><br>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="" for="price" class="col-md-3 col-form-label text-right">Price</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
                                        <div class="">
                                    ...
                                    <div class="form-group row">
                                        <label for="procat_id" class="col-md-3 col-form-label text-right">Product Category</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="prosubcat_id" class="col-md-3 col-form-label text-right">Product Sub Category</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label text-right">Company</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="min_quantity" class="col-md-3 col-form-label text-right">Minimum Order of Quantity (MOQ)</label>&nbsp;<i class="fa fa-asterisk text-danger"></i><br>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="picture" class="col-md-3 col-form-label text-right">Product Picture</label>&nbsp;<i class="fa fa-asterisk text-danger"></i><br>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="tags" class="col-md-3 col-form-label text-right">Tags</label>
                                        <div class="col-md-9">
