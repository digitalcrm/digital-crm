<nav class="main-header navbar navbar-expand navbar-light navbar-light fixed-top">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class=""><a href="{{ url('products/create') }}" class="btn btn-sm btn-primary mr-4"><i class="far fa-plus-square mr-1"></i> Add Product</a></li>
        <li class=""><a href="{{ route('companies.create') }}" class="btn btn-sm btn-default"><i class="far fa-plus-square mr-1"></i> Add Company</a></li>
