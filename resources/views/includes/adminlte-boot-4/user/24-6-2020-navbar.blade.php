...
<!--                <span class="dropdown-item dropdown-header"  id='limsg'></span>
    ...
    <a href="#" class="dropdown-item dropdown-footer">See All Notifications</a>-->
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <i class="fas fa-plus-square mr-1"></i><i class="fas fa-angle-down"></i>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right pb-2">
			<div class="text-bold small px-3 py-1">Add New</div>
			<div class="dropdown-divider"></div>
                <a href="{{url('webtolead/create')}}" class="dropdown-item small text-muted">
                    Web to Lead
                </a>
				<a href="{{url('accounts/create')}}" class="dropdown-item small text-muted">
                    Account
                </a>
                <a href="{{url('contacts/create')}}" class="dropdown-item small text-muted">
                    Contact
                </a>
                <a href="{{url('leads/create')}}" class="dropdown-item small text-muted">
                    Lead
                </a>
                <a href="{{url('deals/create')}}" class="dropdown-item small text-muted">
                    Deal
                </a>
                <a href="{{url('territory/create')}}" class="dropdown-item small text-muted">
                    Territory
                </a>
                <a href="{{url('forecast/create')}}" class="dropdown-item small text-muted">
                    Forecast
                </a>

                <a href="{{url('products/create')}}" class="dropdown-item small text-muted">
                    Product
                </a>
                <a href="{{url('invoice/create')}}" class="dropdown-item small text-muted">
                    Invoice
                </a>
            </div>
        </li>
