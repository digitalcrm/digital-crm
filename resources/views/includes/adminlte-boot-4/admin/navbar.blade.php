        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body py-4">
                    <!-- SEARCH FORM -->
                    <form action="{{route('admin.search.getsearchresults')}}" method="get" class="form-inline ml-3 pull-right">
                        @csrf

                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <select id="searchfield" name="searchfield" class="selectpicker form-control  form-control-lg">
                            ...
                            <input type="text" class="form-control form-control-lg" placeholder="Search" id="searchTerm" name="search" >
