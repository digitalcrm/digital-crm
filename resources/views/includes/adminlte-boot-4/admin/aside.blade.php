...
<aside class="main-sidebar sidebar-light-primary">
    ...
    <a href="{{url('admin/dashboard')}}" class="brand-link">
        <!-- asset('assets/adminlte-boot-4/dist/img/AdminLTELogo.png') -->
        <img src="{{url($app->app_picture)}}" alt="Digital CRM" class="brand-image elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <nav class="">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('isAdmin')
                <li class="nav-item">
                    <a href="{{url('admin/admins')}}" class="nav-link {{ request()->is('admin/admins*') ? 'active' : '' }} {{ request()->is('admin/mails/mailsend/users*') ? 'active' : '' }}">
                ...
                @can('isAdmin')
                <li class="nav-item">
                    <a href="{{url('admin/clients')}}" class="nav-link {{ request()->is('admin/clients*') ? 'active' : '' }} {{ request()->is('admin/mails/mailsend/clients*') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-user-circle icon-size"></i>
                        <p>Clients</p>
                    </a>
                </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview" style="display: none;">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/leads/getproductleads/list')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Product Leads</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{url('admin/documents')}}" class="nav-link {{ request()->is('admin/documents*') ? 'active' : '' }}">
                        <i class="nav-icon fab fa-product-hunt icon-size"></i>
                        <p>Documents</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('rfqs.index') }}" class="nav-link {{ request()->is('rfqs*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.ticket',['all' => 'true']) }}" class="nav-link {{ request()->is('admin/ticket') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-trash icon-size"></i>
                        <p>Ticketing</p>
                    </a>
                </li>
