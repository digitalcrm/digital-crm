<div class="col-lg-6">
    <form wire:submit.prevent="update">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="personal_name" type="text" class="form-control required" name="personal_name" id="personal_name" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="position" type="text" class="form-control required" name="position" id="position" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="c_email" wire:model="c_email" type="email" class="form-control" name="c_email" id="c_email" placeholder="your company email">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="c_mobileNum" wire:model="c_mobileNum" type="tel" class="form-control required" name="c_mobileNum" id="c_mobileNum" placeholder="">
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label text-right" for="c_whatsappNum">WhatsApp
                Number</label>
            <div class="col-md-9">
                <input wire:model="c_whatsappNum" type="tel" class="form-control" name="c_whatsappNum" id="c_whatsappNum" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="c_name" type="text" class="form-control required" name="c_name" id="c_name" placeholder="company name">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <select wire:model="category_id" class="form-control required" name="category_id" id="category_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <select wire:model="actype_id" class="form-control required" name="actype_id" id="actype_id">
                    <option value="0">Select Type</option>
                    @if ($companyType)
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <textarea wire:model="c_bio" name="c_bio" id="c_bio" class="form-control required" rows="5"></textarea>
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label text-right " for="c_logo">Company Logo
                Picture</label>
            <div class="col-md-9">
                <input wire:model="c_logo" type="file" class="btn btn-default required" name="c_logo" id="c_logo" />
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="c_cover" type="file" class="btn btn-default" name="c_cover" id="c_cover" />
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="c_webUrl" type="text" class="form-control" name="c_webUrl" id="c_webUrl" placeholder="">
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label text-right" for="c_gstNumber">Company Gst
                Number</label>
            <div class="col-md-9">
                <input wire:model="c_gstNumber" type="text" class="form-control required" name="c_gstNumber" id="c_gstNumber" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="employees" type="number" class="form-control required" name="employees" id="employees" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="yt_video_link" type="text" class="form-control" name="yt_video_link" id="yt_video_link" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="google_map_url" type="text" class="form-control" name="google_map_url" id="google_map_url" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="fb_link" type="text" class="form-control" name="fb_link" id="fb_link" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="tw_link" type="text" class="form-control" name="tw_link" id="tw_link" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="linkedin_link" type="text" class="form-control" name="linkedin_link" id="linkedin_link" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="yt_link" type="text" class="form-control" name="yt_link" id="yt_link" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <textarea wire:model="address" name="address" class="form-control" id="address" cols="30" rows="5"></textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="city" type="text" class="form-control required" name="city" id="city" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <select wire:model="country_id" class="form-control required" name="country_id" id="country_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input wire:model="zipcode" type="text" class="form-control required" name="zipcode" id="zipcode" placeholder="">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9 form-check">
                <input wire:model="showLive" type="checkbox" class="form-check-input" name="showLive" id="showLive">
        ...
        <div class="form-group row">
            <div class="col-md-3"></div>
            <div class="col-md-9 form-check">
                <input wire:model="termsAccept" type="checkbox" class="form-check-input" name="termsAccept" id="termsAccept">
