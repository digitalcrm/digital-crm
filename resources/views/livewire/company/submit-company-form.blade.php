            ...
            <div class="card shadow card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <h3 class="badge badge-default text-danger">Personal Details</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3"></div>
                        <div class="col-md-9">
                            <h3 class="badge badge-default text-danger">Company Information</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3"></div>
                        <div class="col-md-9">
                            <h3 class="badge badge-default text-danger">Google Details</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3"></div>
                        <div class="col-md-9">
                            <h3 class="badge badge-default text-danger">Social Profiles</h3>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3"></div>
                        <div class="col-md-9">
                            <h3 class="badge badge-default text-danger">Address Information</h3>
                        </div>
                    </div>
