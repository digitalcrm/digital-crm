                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                ...
                                <!--<a href="<?php echo url('files/' . $data->file_id . '/edit'); ?>" class="btn btn-primary btn-flat pull-right">Edit</a>-->
                            </div>
                            <div class="box-body">
                                <?php
                                ...
                                echo "<iframe src='" . $data->file . "' frameborder='0'
                            ...
                            <div class="box-footer">
                                <div class="btn-group btn-flat pull-right">
                                    <a href="{{ url('files') }}" class="btn btn-default">Back</a>
