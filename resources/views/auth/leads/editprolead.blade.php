            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        {{Form::open(['action'=>['LeadController@updateProductLead',$data['leadarr']['ld_id']],'method'=>'Post','enctype'=>'multipart/form-data'])}}
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="card-footer bg-white pull-right text-right">
                            <a href="{{url('leads/getproductleads/list')}}" class="btn btn-outline-secondary mr-1">Cancel</a>
