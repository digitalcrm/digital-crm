                    ...
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control required" name="last_name" id="last_name" placeholder="" value="{{$data['leadarr']['last_name']}}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="email" class="form-control required" name="email" id="email" placeholder="" value="{{$data['leadarr']['email']}}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder="" value="{{$data['leadarr']['mobile']}}">
