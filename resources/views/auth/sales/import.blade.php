        ...
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <!-- form start -->
                    <!-- <form role="form" > -->
                    {{Form::open(['action'=>'SalesController@importData','method'=>'Post','enctype'=>'multipart/form-data'])}} 
                    @csrf
                    <div class="card-body p-0">
                        ...
                        <section class="col-lg-6">
                            ...
                            <div class="form-group">
                                <p><a href="<?php echo url('uploads/samples/tbl_sales_upload.csv'); ?>">click here to download sample csv file</a></p>
                            </div>
                    ...
                    <div class="card-footer bg-white border-top pull-right text-right">
                        <div class="btn-group btn-flat pull-right">
                            <a href="{{url('/sales')}}" class="btn btn-default">Back</a>
