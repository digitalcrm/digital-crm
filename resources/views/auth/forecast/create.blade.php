...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h1><i class="far fa-edit"></i> New Forecast</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                            ...
                            <section class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right date-picker-year" name="year" id="datepicker" required value="<?php echo date('Y'); ?>">
                            ...
                            <div class="row">
                                ...
                                <section class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend"><span class="input-group-text">{!!$data['user']['currency']['html_code']!!}</span></div>
