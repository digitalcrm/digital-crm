            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card shadow card-primary card-outline">
                        <!-- /.card-header -->
                        {{Form::open(['action'=>['OrderController@update',$data->oid],'method'=>'Post'])}}
                        @csrf
                        <div class="card-body">
                                    ...
                                    <div class="form-group row">
										...
										<div class="input-group">
                                            ...
                                            <input class="form-control required" type="text" value="{!!$data['tbl_deals']['value']!!}" id="amount" name="amount" readonly>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
										<input class="form-control required" type="number" value="{!!$data['number']!!}" id="number" name="number" required>
                                    ...
                                    <div class="form-group row">
										...
										<div class="input-group">
                                            ...
                                            <input class="form-control required" type="text" value="{!!date('d-m-Y', strtotime($data['order_date']))!!}" id="order_date" name="order_date" required>
                                    ...
                                    <div class="form-group row">
										...
										<div class="input-group">
                                            ...
                                            <input class="form-control required" type="text" value="{!!date('d-m-Y', strtotime($data['shipping_date']))!!}" id="shipping_date" name="shipping_date" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
										<select class="form-control required" name="pos_id" id="pos_id" required>
                                            {!!$data['orderoptions']!!}
                                        </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
										<select class="form-control required" name="dlb_id" id="dlb_id" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
										<input class="form-control required" type="number" value="{!!$data['quantity']!!}" id="quantity" name="quantity" min=1 required>
                                    ...
                                    <div class="form-group row">
										...
										<div class="input-group">
                                            ...
                                            <input class="form-control required" type="text" value="{!!$data['total_amount']!!}" id="total_amount" name="total_amount" readonly>
