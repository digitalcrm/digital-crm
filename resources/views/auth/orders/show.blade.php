                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="<?php echo url('orders/' . $data->oid . '/edit'); ?>" class="btn btn-primary btn-block"><b>Edit</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Lead Source</b> <a class="float-right"><?php echo $data['leadsource']['leadsource']; ?></a>
                                </li>
                                <li class="list-group-item">
                            ...
                            <a href="<?php echo url('deals/' . $data['tbl_deals']['deal_id'] . '/edit'); ?>" class="btn btn-primary btn-block"><b>Edit</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card shadow card-primary card-outline">
                        ...
                        <div class="card-footer bg-white border-top pull-right text-right">
                            ...
                            <a href="{{url('orders')}}" class="btn btn-sm btn-outline-secondary"><i class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                        </div>
                    </div>
                </div>
            </div>
