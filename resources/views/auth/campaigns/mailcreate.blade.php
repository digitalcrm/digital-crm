        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <!-- form start -->
                    <!-- <form role="form" > -->
                    {{Form::open(['action'=>['CampaignController@storeCampaignMails',$data['camp_id']],'method'=>'Post','enctype'=>'multipart/form-data'])}} 
                    <!--store-->
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer text-right pull-right">
                            <a href="{{url('campaigns/mails/sent/'.$data['camp_id'])}}" class="btn btn-outline-secondary">Cancel</a>
