            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card shadow card-primary card-outline">
                        <!-- <form role="form" > -->
                        {{Form::open(['action'=>'RdController@store','method'=>'Post','enctype'=>'multipart/form-data'])}}
                        @csrf
                        <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
										<input type="text" class="form-control required" name="title" id="title" placeholder="" value="{{old('dealname')}}" required tabindex="1">
                                    ...
                                    <!-- <div class="form-group row">
                                        <label class="col-md-3 col-form-label text-right" for="intype_id">Industry Type</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label text-right" for="createdate">Creation Date</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label text-right" for="submitdate">Submission Date</label>
                                        <div class="col-md-9">
										<div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
