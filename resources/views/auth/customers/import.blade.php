        ...
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="card shadow card-primary card-outline">
                    <!-- form start -->
                    <!-- <form role="form" > -->
                    {{Form::open(['action'=>'CustomersController@importData','method'=>'Post','enctype'=>'multipart/form-data'])}} 
                    @csrf
                    <div class="card-body p-0">
                        ...
                        <section class="col-lg-6">
                            ...
                            <div class="form-group">
                                <p><a href="<?php echo url('uploads/samples/tbl_customers_upload.csv'); ?>">click here to download sample csv file</a></p>
                            </div>
