            ...
            <!-- Small cardes (Stat card) -->
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="text-bold">
                                    <h4 id="wonAmount">Total Amount </h4>
                                </div>
                                <div id="funnelPanel">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-info">
                            <div class="card-header with-border">
                                <h3 class="card-title">latest Deals&nbsp;<span class="badge"><?php echo $data['latestDeals']['total']; ?></span></h3>
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <div class="card card-info">
                            <div class="card-header with-border">
                                <div class="col-lg-3 pull-left">
                                    <h3 class="card-title">Web to Lead</h3>
                                </div>
                                <div class="col-lg-2">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-info">
                            <div class="card-header">
                                <h2 class="card-title">Global Reports</h2>
                            </div>
                            <div class="card-body">
                                <div id="globalreportsDiv">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-info">
                            <div class="card-header with-border">
                                <h3 class="card-title">Sub Users&nbsp;<span class="badge">{!!$data['subusers']['total']!!}</span></h3>
                            </div>
                            <div class="card-body">
                                {!!$data['subusers']['table']!!}
                            </div>
