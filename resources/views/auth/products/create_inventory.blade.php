               ...
               <div class="row">
                    <div class="col-lg-8">
                         ...
                         <div class="card shadow card-primary card-outline">
                              ...
                              {{Form::open(['action'=>['ProductController@storeInventory'],'method'=>'Post','enctype'=>'multipart/form-data'])}}
                              @csrf
                              <div class="card-body">
                                   <!-- Left col -->
                                   <div class="row">
                                        <div class="col-lg-6">
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="productid" id="productid" placeholder="" value="" required>
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="qrcode" id="qrcode" placeholder="" value="" required>
                                        ...
                                        <div class="col-lg-6">
                                             <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="productsku" id="productsku" placeholder="" value="" required>
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="supply_price" id="supply_price" placeholder="" value="" required>
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="location" id="location" placeholder="" value="" required>
