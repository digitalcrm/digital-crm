                ...
                <div class="col-sm-8">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a class="btn btn-sm btn-default mr-1" href="{{url('products')}}"><i class="fas mr-1"></i>Products</a>
                            <a class="btn btn-sm btn-primary mr-1" href="{{url('products/inventory/create')}}"><i class="far fa-plus-square mr-1"></i>Add Inventory</a>
                        </li>
                    </ol>
                </div>
            </div>
...
<script>
    ...
    var updateCurrentStockStatus = "{{url('products/update/currentstock/status')}}";
    $(function() {
