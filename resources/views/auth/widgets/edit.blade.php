            ...
            <div class="col-lg-12">
                ...
                <div class="card box-primary">
                    ...
                    <div class="card-header with-border">
                        <h3 class="card-title">
                            <img src="<?php echo ($data['accountarr']['picture'] != "") ? url($data['accountarr']['picture']) : url('/uploads/default/accounts.png'); ?>" height="30" width="30" />&nbsp;
                    ...
                    <div class="card-body">
                        ...
                        <section class="col-lg-4">
                            <div class="form-group">
                                <label for="first_name">Account Name</label>&nbsp;<i class="fa fa-asterisk text-danger"></i>
