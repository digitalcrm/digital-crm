                                ...
                                <div class="card shadow card-primary card-outline">
                                    <div class="card-body card-profile">
                                        ...
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item">
                                                <b>Daily Reports</b> <a class="pull-right"><?php echo
                                                    $data['userdata']['daily_reports'] == 1 ? 'Yes' : 'No'; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Newsletter</b> <a class="pull-right"><?php echo
                                                    $data['userdata']['newsletter'] == 1 ? 'Yes' : 'No'; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Country</b> <a class="pull-right"><?php echo
                                                    $data['userdata']['country'] > 0 ?
                                                    $data['userdata']['tbl_countries']['name'] : ''; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>State</b> <a class="pull-right"><?php echo
                                                    $data['userdata']['state'] > 0 ? $data['userdata']['tbl_states']['name']
                                                    : ''; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>City</b> <a class="pull-right"><?php echo
                                                    $data['userdata']['city'] != '' ? $data['userdata']['city'] : ''; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Zip</b> <a class="pull-right"><?php echo
                                                    $data['userdata']['zip'] != '' ? $data['userdata']['zip'] : ''; ?></a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="card-body p-0">
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab"
                                                    href="#nav-products" role="tab" aria-controls="nav-home"
                                                    aria-selected="true">Products</a>
                                                <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab"
                                                    href="#nav-companies" role="tab" aria-controls="nav-home"
                                                    aria-selected="true">Companies</a>
                                                <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab"
                                                    href="#nav-home" role="tab" aria-controls="nav-home"
                                                    aria-selected="true">Sub Users</a>
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="nav-profile" role="tabpanel"
                                                ...
                                                <div class="card-body p-0">
                                                    <table id="globalreports" class="table table-striped">
                                                        <tbody>
                                                            <?php $global_reports = $data['global_reports'];
                                                            ?>

                                                            <tr>
                                                                <td>Sub Users</td>
                                                                <td><?php echo $global_reports['subusers'];
                                                                    ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Accounts</td>
                                                                <td><?php echo $global_reports['accounts'];
                                                                    ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Contacts</td>
                                                                <td><?php echo $global_reports['contacts'];
                                                                    ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Leads</td>
                                                            ...
                                                            <tr>
                                                                <td>Customers</td>
                                                                <td><?php echo $global_reports['customers'];
                                                                    ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Sales</td>
                                                            ...
                                                            <tr>
                                                                <td>Form Leads</td>
                                                                <td><?php echo $global_reports['formleads'];
                                                                    ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Events</td>
                                                            ...
                                                            <tr>
                                                                <td>Territory</td>
                                                                <td><?php echo $global_reports['territory'];
                                                                    ?></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="tab-pane fade" id="nav-products" role="tabpanel"
                                                aria-labelledby="nav-home-tab">
                                                <div class="card-body p-0">
                                                    <?php echo $data['products']['table']; ?>
                                                </div>
                                            </div>
                                            <!--Companies--->
                                            <div class="tab-pane fade" id="nav-companies" role="tabpanel"
                                                aria-labelledby="nav-home-tab">
                                                <div class="card-body p-0">
