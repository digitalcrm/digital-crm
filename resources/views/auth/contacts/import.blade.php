...
<!--                        <div class="card-header with-border">
                        ...
                        <!-- form start -->
                        <!-- <form role="form" > -->
                        {{Form::open(['action'=>'ContactController@importData','method'=>'Post','enctype'=>'multipart/form-data'])}} 
                        @csrf
                        <div class="card-body p-0">
                            ...
                            <section class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <p><a href="<?php echo url('uploads/samples/tbl_contacts_upload.csv'); ?>">click here to download sample csv file</a></p>
                                </div>
                            </section>
                        </div>
                        <!-- /.card-body -->
