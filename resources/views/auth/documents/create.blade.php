...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h1><i class="far fa-edit"></i> New Document</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="col-lg-6">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <div class="card-body">
                        <section class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="btn btn-default" name="document" id="document" /><br>
                    ...
                    <div class="card-footer bg-white border-top text-right pull-right">
                        <a href="{{url('/documents')}}" class="btn btn-outline-secondary mr-1">Cancel</a>
