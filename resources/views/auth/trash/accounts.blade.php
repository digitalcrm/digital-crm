        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 mt-1">
                    <h1>Account <small class="badge badge-secondary">{{$data['total']}}</small></h1>
                </div>
                <!--
		  <div class="btn-group btn-flat pull-right">
            <a class="btn bg-blue" href="{{url('accounts/create')}}"><i class="fas fa-plus"></i> Add New</a>
            <a class="btn btn-default" href="{{url('reports/accounts')}}"><i class="fa fa-area-chart"></i>&nbsp;Reports</a>
          </div>-->
            </div>
        </div><!-- /.container-fluid -->
    </section>
...
<script>
    var restoreAllUrl = "{{url('accounts/restoreAll/{id}')}}";
    $(function() {
