...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-4">
                    <h1><i class="far fa-edit"></i> New Template</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    {{Form::open(['action'=>'MailTemplateController@store','method'=>'Post','enctype'=>'multipart/form-data'])}} 
                    @csrf
                    <div class="card-body">
                        <!-- Left col -->
                        <section class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="templatename" placeholder="" value="{{old('name')}}" required>
