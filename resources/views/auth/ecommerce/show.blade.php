...
$cart_order = $data['cart_order'];
// echo $cart_order->city;
// exit();
?>
                    ...
                    <div class="card card-widget">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="cmobile" id="cmobile" placeholder="Mobile" required value="<?php echo $data['cart_order']['mobile']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="country" id="country" placeholder="Country" required value="<?php echo ($data['cart_order']['tbl_countries'] != '') ? $data['cart_order']['tbl_countries']['name'] : ''; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="state" class="col-sm-4 control-label">State</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="state" id="state" placeholder="State" required value="<?php echo (($data['cart_order']['tbl_states'] != '') ? $data['cart_order']['tbl_states']['name'] : ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="city" id="city" placeholder="" value="<?php echo $cart_order->city; ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-footer">
                            <a href="{{url('ecommerce/'.$data['cart_order']->coid.'/edit')}}" class="btn btn-primary" id="">Edit</a>
                            <a href="{{url('ecommerce/orders/list')}}" class="btn btn-primary" id="">Back</a>
                        </div>
                    </div>
                </div>
                <!-- </section> -->
