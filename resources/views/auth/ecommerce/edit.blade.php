            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="card card-widget">
                        ...
                        <!-- /.card-header -->
                        {{Form::open(['action'=>['EcommerceController@update',$data['cart_order']->coid],'method'=>'Post','enctype'=>'multipart/form-data'])}}
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  class="form-control" name="mobile" id="mobile" placeholder="Mobile" value="<?php $data['cart_order']['mobile']; ?>">
...
<script>
    var stateurl = "{{url('ajaxwebtolead/getStateoptions')}}";
    $(function() {
