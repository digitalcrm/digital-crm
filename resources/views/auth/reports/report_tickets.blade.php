                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active"
                                    ...
                                    aria-controls="home"
                                    aria-selected="true"
                                    onclick="return getFormtasks('days');">Day</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"
                                    id="profile-tab"
                                    ...
                                    onclick="return getFormtasks('weeks');">Week</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link"
                                    id="contact-tab"
                                    ...
                                    onclick="return getFormtasks('months');">Month</a>
                            </li>
                        </ul>
...
<script>
    ...
    var dayurl = "{{url('reports/getDaytickets/{time}/{form_id}')}}";
    var weekurl = "{{url('reports/getWeektickets/{time}/{form_id}')}}";
    var monthurl = "{{url('reports/getMonthtickets/{time}/{form_id}')}}";
    $(function() {
        // $(".sidebar-menu li").removeClass("active");
        // $("#lireports").addClass("active");

        getDaytickets(default_form);
        $("#timer").val('days');
    ...
    function getDaytickets(id) {
        $.get(dayurl, {'time': 'day', 'form_id': id}, function(result) {
            var res = eval("(" + result + ")");
            var data = res.formtickets;
            var label = res.label;
