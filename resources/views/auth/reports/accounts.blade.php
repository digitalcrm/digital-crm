                ...
                <div class="card shadow card-primary card-outline card-primary card-outline">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#tab_1" role="tab" aria-controls="home" aria-selected="true" onclick="return getDayAccounts();">Day</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_2" role="tab" aria-controls="profile" aria-selected="false" onclick="return getWeekAccounts();">Week</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#tab_3" role="tab" aria-controls="contact" aria-selected="false" onclick="return getMonthAccounts();">Month</a>
                            </li>
                        </ul>
...
<script>
                                                var dayurl = "{{url('reports/getDayAccounts')}}";
                                                var weekurl = "{{url('reports/getWeekAccounts')}}";
                                                var monthurl = "{{url('reports/getMonthAccounts')}}";
                                                $(function() {
