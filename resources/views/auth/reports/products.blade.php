          ...
          <div class="col-md-10">
               <div class="card shadow card-primary card-outline card-primary card-outline">
                    ...
                    <div class="card-footer bg-white pull-right text-right">
                         <a href="{{url('products')}}" class="btn btn-sm btn-outline-secondary"><i class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                    </div>
               </div>
               <!-- /.card -->
          </div>
...
<script>
     var dayurl = "{{url('reports/getdayproducts')}}";
     var weekurl = "{{url('reports/getweekproducts')}}";
     var monthurl = "{{url('reports/getmonthproducts')}}";
     $(function() {
