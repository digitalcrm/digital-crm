                    ...
                    <div class="card-body p-0">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item active-bg">
                                <a href="{{url('reports/contacts')}}" class="nav-link text-primary">
                                    Contacts
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="card shadow card-primary card-outline card-primary card-outline">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#tab_1" role="tab" aria-controls="home" aria-selected="true" onclick="return getDayContacts();">Day</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_2" role="tab" aria-controls="profile" aria-selected="false" onclick="return getWeekContacts();">Week</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#tab_3" role="tab" aria-controls="contact" aria-selected="false" onclick="return getMonthContacts();">Month</a>
                            </li>
                        </ul>
...
<script>
                                    var dayurl = "{{url('reports/getDayContacts')}}";
                                    var weekurl = "{{url('reports/getWeekContacts')}}";
                                    var monthurl = "{{url('reports/getMonthContacts')}}";
                                    $(function() {
