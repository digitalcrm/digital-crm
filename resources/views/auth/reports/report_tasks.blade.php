...
<script>
    ...
    var dayurl = "{{url('reports/getDaytasks/{time}/{form_id}')}}";
    var weekurl = "{{url('reports/getWeektasks/{time}/{form_id}')}}";
    var monthurl = "{{url('reports/getMonthtasks/{time}/{form_id}')}}";
    $(function() {

        getDaytasks(default_form);
        $("#timer").val('days');
