...
@section('content')
                    ...
                    <div class="col-md-10">
                        <div class="card shadow card-primary card-outline card-primary card-outline">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#tab_1" role="tab"
                                            ...
                                            onclick="return getDayLeads();">Day</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_2" role="tab"
                                            aria-controls="profile" aria-selected="false"
                                            onclick="return getWeekLeads();">Week</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#tab_3" role="tab"
                                            aria-controls="contact" aria-selected="false"
                                            onclick="return getMonthLeads();">Month</a>
                                    </li>
                                </ul>
                            ...
                            <div class="card-footer bg-white pull-right text-right">
                                <a href="{{ url('leads') }}" class="btn btn-sm btn-outline-secondary"><i
                                        class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                            </div>
                        </div>
                        <!-- /.card -->
                    </div>
    ...
    <script>
        var dayurl = "{{ url('reports/getdayproductleads') }}";
        var weekurl = "{{ url('reports/getweekproductleads') }}";
        var monthurl = "{{ url('reports/getmonthproductleads') }}";
        $(function() {
