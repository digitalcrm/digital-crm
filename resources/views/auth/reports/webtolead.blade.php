                ...
                <div class="card shadow card-primary card-outline card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#tab_1" role="tab" aria-controls="home" aria-selected="true" onclick="return getFormleads('days');">Day</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tab_2" role="tab" aria-controls="profile" aria-selected="false" onclick="return getFormleads('weeks');">Week</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#tab_3" role="tab" aria-controls="contact" aria-selected="false" onclick="return getFormleads('months');">Month</a>
                            </li>
                        </ul>
                    ...
                    <div class="card-footer bg-white pull-right text-right">
                        <a href="{{url('webtolead')}}" class="btn btn-sm btn-outline-secondary mr-1"><i class="nav-icon fas fa-long-arrow-alt-left"></i></a>
                    </div>
                </div>
                <!-- /.card -->
            </div>
...
//                                        alert(default_form);
                                    var dayurl = "{{url('reports/getDayFormleads/{time}/{form_id}')}}";
                                    var weekurl = "{{url('reports/getWeekFormleads/{time}/{form_id}')}}";
                                    var monthurl = "{{url('reports/getMonthFormleads/{time}/{form_id}')}}";
                                    $(function() {

                                        $(".sidebar-menu li").removeClass("active");
                                        $("#lireports").addClass("active");

                                        getDayFormleads(default_form);
                                        $("#timer").val('days');
...
//                                                    alert(id + " " + time);
                                    ...
                                    function getDayFormleads(id) {
//                                            alert('getDayFormleads Id: ' + id);
